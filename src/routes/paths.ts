...
export const PATH_GUEST = {
  ...
  general: {
    ...
    productView: (name: string) => path(ROOTS_GUEST, `/product/${name}`),
    demoView: path(ROOTS_GUEST, '/product/nike-air-force-1-ndestrukt'),
    checkout: path(ROOTS_GUEST, '/checkout'),
    thanks: path(ROOTS_GUEST, '/thanks'),
  },
};
