...
// GUEST
const GuestInvitation = Loadable(lazy(() => import('../pages/guests/GuestInvitationPage')));
const GuestShop = Loadable(lazy(() => import('../pages/guests/GuestShop')));
const GuestProductDetails = Loadable(lazy(() => import('../pages/guests/GuestProductDetails')));
const GuestCheckout = Loadable(lazy(() => import('../pages/guests/GuestCheckout')));
const GuestThanks = Loadable(lazy(() => import('../pages/guests/GuestShop')));
